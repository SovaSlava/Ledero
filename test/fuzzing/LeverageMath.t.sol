...
contract LeverageMathFuzzTest is Test {
    function testFuzz_CalcSafeBorrowAmount(
        ...
        uint256 absDelta =
            safeBorrow > expectedSafeBorrow ? safeBorrow - expectedSafeBorrow : expectedSafeBorrow - safeBorrow;
    ...
    function testFuzz_CalcFlashLoanAmount(uint256 collateralAmount, uint256 desiredLeverage) public pure {
    ...
    function testFuzz_CalcMaxLeverage(uint256 ltv) public pure {
