...
library LeverageMath {
    uint256 internal constant LEVERAGE_PRECISION = 10000;
    uint256 internal constant LTV_PRECISION = 10000;
    uint256 internal constant BORROW_SAFETY_MARGIN = 9500; // 95% from LTV
